    ...
    <form action="" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div id="image_show">
                    <a href="{{asset('template/slider/'. $slider->thumb) }}">
                        <img src="{{asset('template/slider/'. $slider->thumb) }}" width="100px">
                    </a>
                </div>
                <input type="hidden" name="thumb" value="{{asset('template/slider/'. $slider->thumb) }}" id="thumb">
            </div>
