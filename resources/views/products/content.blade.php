                            ...
                            <div class="wrap-slick3-dots">
                                <ul class="slick3-dots" style="" role="tablist">
                                    <li class="slick-active" role="presentation">
                                        <img src="{{ asset('template/product/'.$product->thumb) }}">
                                    ...
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        <div class="item-slick3 slick-slide slick-current slick-active"
                                            ...
                                            <div class="wrap-pic-w pos-relative">
                                                <img src="{{ asset('template/product/'.$product->thumb) }}" alt="IMG-PRODUCT">
...
<form action="{{ route('addToFavorites', ['id' => $product->id]) }}" method="POST">
                            <button type="submit" class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn6 trans-02" tabindex="0">
                                    ...
                                    <form action="/add-cart" method="post">
                                        @if ($product->price !== NULL)
                                            ...
                                            <div class="flex-container">
                                                <button type="submit" class="button flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
                                                    Thêm vào giỏ hàng
                                                </button>
            ...
            <div class="tab-pane fade show active" id="description" role="tabpanel">
                <div class="row">
                    <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                        <!-- Hiển thị product->description ở đây dưới dạng văn bản bình thường -->
                        <div class="stext-102 cl6 size-206">
                            {{ $product->description }}
                        </div>
                    </div>
                </div>
